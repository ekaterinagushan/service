...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { actual_danger_id: @parameter.actual_danger_id, ingredient_id: @parameter.ingredient_id } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { actual_danger_id: @parameter.actual_danger_id, ingredient_id: @parameter.ingredient_id } }
